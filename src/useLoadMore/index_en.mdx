...
A Hook that is suitable for clicking to load more or pull up to load more scenarios.

**Core Characteristics**

* Async request control(loading, request timing control, etc)
* Logic that encapsulates common loadMore scenarios
* Support dynamic data loadMore scene
...
<JackBox jsCode={Demo2CodeJsx} tsCode={Demo2CodeTsx} demoName='Pull up load more' description='If ref exists in options, loadMore is automatically triggered when scrolling to the bottom'>
  <Demo2 />
</JackBox>

### Rational use of deps

<JackBox jsCode={Demo3CodeJsx} tsCode={Demo3CodeTsx} demoName='Rational use of deps' description='If the deps changes, reset the current page and re-request the data'>
  <Demo3 />
</JackBox>

### Dynamic data loading - timestamp mode

<JackBox jsCode={Demo4CodeJsx} tsCode={Demo4CodeTsx} demoName='Dynamic data loading - timestamp mode' description={
  <div>
...
### Dynamic data loading - ID mode

<JackBox jsCode={Demo5CodeJsx} tsCode={Demo5CodeTsx} demoName='Dynamic data loading - ID mode' description={
  <div>
