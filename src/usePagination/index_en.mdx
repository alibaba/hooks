...
Hook for common asynchronous paging scenarios.

## Examples

### Basic usage

<JackBox jsCode={Demo1CodeJsx} tsCode={Demo1CodeTsx} demoName='Basic usage' description='Simple page list'>
  <Demo1 />
</JackBox>

### Rational use of deps

<JackBox jsCode={Demo2CodeJsx} tsCode={Demo2CodeTsx} demoName='Rational use of deps' description='When deps changes, it initializes to the first page'>
  <Demo2 />
</JackBox>
