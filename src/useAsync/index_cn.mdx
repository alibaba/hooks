...
<JackBox tsCode={Demo1CodeTs} jsCode={Demo1CodeJs} demoName='默认用法' description='组件加载时立即执行'>
  <Demo1 />
</JackBox>
...
params:(
  ...
  deps: DependencyList = [],
  options: {
    onSuccess?: (d: T, params: any[]) => void // 执行成功的回调
    onError?: (e: Error, params: any[]) => void // 执行失败时的回掉
