...
<JackBox jsCode={Demo3CodeJsx} tsCode={Demo3CodeTsx} demoName='Persist objects with function updater' description='function updater is also acceptable with useSessionStorageState.'>
  <Demo3 />
</JackBox>
