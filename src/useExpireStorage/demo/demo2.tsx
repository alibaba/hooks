...
export default () => {
  const { value, setValue, remove } = useExpireStorage('sessionKey', '', 'sessionStorage');
  ...
  return (
    <div>
      <p>
        <Alert message="value will remove when close browser tab" type="warning" showIcon banner />
      </p>
