...
function Y(props: ISimpleProps) {
  ...
  const { isMoving, positions } = useTouchScroll({ ref: ref, deviationYBase: 50 });
  ...
  return (
    <div>
      ...
      <p>根据当前移动距离判断是上移还是下移多少基准高度，当前案例为y轴50px</p>
      <p>
        According to the current moving distance, judge whether to move top or bottom. The current
        case is Y-axis 50 px
      </p>
      ...
      <div style={{ backgroundColor: 'black', height: '200px', overflow: 'hidden' }}>
        <div
          style={{
            ...{
              transform: `translateY(${positions.base.y + positions.deviation.y}px)`,
